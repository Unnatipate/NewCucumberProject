...
//Register Page
    ...
    public void click_on_register_submit_button() {
        registrationPage.clickOnDetailsButton();
    }

    @Then("user should able to register successfully")
    public void user_should_able_to_register_successfully() {
        resgisterResultPage.verifyUserIsOnRegisterSuccessPage();
        resgisterResultPage.verifyUserHasSuccessfullyRegistered();
    }
//checkout page
    ...
    public void user_fills_comments_form() {
        newsCommentPage.checkUserIsInTheNewReleasePage();
        newsCommentPage.fillCommentSection();
    }
    ...
    public void the_user_should_see_the_comment_has_been_posted_successfully() {
        newsCommentPage.checkTheCommentIsPostedSuccessfully();
    }
//Navigate page
    ...
    public void userShouldSeeRelevantSocialMediaPageUrl(String socialURL) {
        alertPopUp.verifyUserIsOnSocialMediaPage(socialURL);
    }
//category feature
    ...
    public void userHoversOverCategoryInMainMenu(String category) {
        categoryURLPage.hoverOverMainMenu(category);
    }

    @And("user clicks on submenu {string}")
    public void userClicksOnSubmenu(String subCategory) {
        categoryURLPage.clickOnSubMenu(subCategory);
    }
